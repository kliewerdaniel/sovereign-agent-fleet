...
>
> **Current reality (this archive predates the `exchange/` package and D24):** the repo has
> **384 passing tests** (not 205), `exchange/` (D29/D30 sovereign prediction-market venue +
> quantitative cognition layer) is a top-level package, and D24 (real ZK attestation) is
> **implemented and merged**. See `D27`/`D28`/`D29`/`D30` for the financial/cognitive evolution.
