"""Phase 6 (M0) — governance issuer side of the FIFTH adapter.

Structurally identical to ``incident/epistemic_adapter/authority.py``. The
...
The point of having a FIFTH, identical issuer: the substrate cannot distinguish
a mirror (agent self-observability) grant from an exchange grant, an incident
grant, a supply grant, or a hypothesis grant. Its decision function reads only
the grant's scope/epoch and the deterministic policy — never the domain. Five
domains, one substrate, zero substrate edits.
"""
...
class GovernanceAuthority:
    """The trusted issuer of AuthorityGrants for the mirror domain.
