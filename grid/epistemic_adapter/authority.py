"""Phase 7 (M0) — governance issuer side of the SIXTH adapter.

Structurally identical to ``mirror/epistemic_adapter/authority.py``. The
...
The point of having a SIXTH, identical issuer: the substrate cannot distinguish a
grid (energy demand-response) grant from an exchange grant, an incident grant, a
supply grant, a hypothesis grant, or a mirror grant. Its decision function reads
only the grant's scope/epoch and the deterministic policy — never the domain.
Six domains, one substrate, zero substrate edits.
"""
...
class GovernanceAuthority:
    """The trusted issuer of AuthorityGrants for the grid domain.
